@include('head')
    ...
    <section class="container py-5">
        ...
        <div class="row pb-4">
            ...
            <!-- Start Contact Form -->
            <div class="col-lg-8 ">
                <form class="contact-form row" method="post" action="{{route("contactstore")}}" role="form">
                    @csrf
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="form-floating">
                            <input type="text" class="form-control form-control-lg light-300" id="floatingemail" name="email" placeholder="Email">
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <textarea class="form-control light-300" rows="8" name="message" placeholder="Message" id="floatingtextarea"></textarea>

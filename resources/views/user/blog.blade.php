...
<div class="container-fluid">
    ...
    <div class="container">
        <form role="form" action="/userx/addblog" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Parent Blog</label>
            ...
            <div class="mb-3">
                ...
                <textarea name="contents" id="myeditor" rows="10" cols="80"></textarea>
            </div>
